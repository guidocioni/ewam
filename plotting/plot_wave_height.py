...
def main():
    ...
    dset = read_dataset(variables=['SWH', 'MWD'],
    ...
    levels_height = [0.1, 0.3, 0.5, 0.8, 1.25, 1.6, 2, 2.5, 3, 4, 5, 6, 7,
                     8, 9]
    dset['u'] = u
    dset['v'] = v
...
def plot_files(dss, **args):
    ...
    for time_sel in dss.time:
        ...
        cs = args['ax'].contourf(args['x'], args['y'], data['swh'],
                         extend='both', cmap=args['cmap'],
                         levels=args['levels_height'])
        ...
        an_var = annotation(args['ax'], 'Wave height and direction',
        ...
        if first:
            plt.colorbar(cs, orientation='horizontal', label='Wave height [m]',
