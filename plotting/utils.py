...
subfolder_images = {
    ...
    'it' : folder_images+'it',
    'moc' : folder_images+'moc',
    'lig' : folder_images+'lig',
    'tir' : folder_images+'tir',
    'adr' : folder_images+'adr',
    'jon' : folder_images+'jon',
    'mor' : folder_images+'mor',
}
...
def read_dataset(variables = ['T_2M', 'TD_2M'], level=None, projection=None,
    ...
    dset = dset.sortby('lat', ascending=True)
    if level:
